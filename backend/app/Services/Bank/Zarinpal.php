...
use App\Services\Bank\Gateway;
use Exception;
use Illuminate\Http\RedirectResponse;

class Zarinpal implements Gateway {

	private static string $REQUEST_URL = "https://sandbox.zarinpal.com/pg/rest/WebGate/PaymentRequest.json";

	private static string $VERIFY_URL = "https://sandbox.zarinpal.com/pg/rest/WebGate/PaymentVerification.json";

	private static string $REDIRECT_URL = "https://sandbox.zarinpal.com/pg/StartPay/";
