...
<body>
    <div style="{{$style['bg']}}">
        ...
        <main style="{{$style['content']['div']}}">
            <div>
                <span style="{{$style['content']['p']}}">
                    کالا {{$product_name}} موجود شد, برای مشاهده برو لینک زیر کلیک نمایید
                </span>
            </div>
            <div>
                <a href="{{$product_link}}" target="_blank" style="{{$style['content']['a']}}">مشاهده کالا</a>
            </div>
        </main>
