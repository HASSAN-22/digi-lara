<template>
  <div class="mt-10 px-8">
    <div class="flex justify-center">
      <span class="!font-medium text-lg">لیست نقش ها</span>
    </div>
    ...
    <Modal :title="isUpdate ? 'ویرایش نقش' : 'ثبت نقش'" :save="isUpdate ? 'ثبت تغییرات' : 'ثبت'" :btnLoading="btnLoading" @callback="isUpdate ? update() : insert()" ref="openModal">
      <Input :required="true" label="نقش" placeholder="نقش" v-model="role" id="role" />
    </Modal>
    <Meta :title="$store.state.siteName + ` | لیست نقش ها `"/>
